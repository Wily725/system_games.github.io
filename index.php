				...
				<div class="card p-2 borde-secondary mb-2">
					<img src="<?= $row['product_image']?>" class="card-img-top" height="250">
					 <div class="card-body p-1">
					 	...
					 	<h5 class="card-text text-center text-danger"><i class="fas fa-hand-pointer"></i>&nbsp;<?= number_format($row['product_price']) ?>&nbsp;$</h5>
					 </div>
					 <div class="card-footer p-1">
					 	<form action="" class="form-submit">
					 		...
					 		<button class="btn btn-info btn-block addItemBtn"><i class="fas fa-cart-plus"></i>&nbsp; Comprar</button>
					 	</form>
